 ...
 */
function resolveHookScriptPath(env: NodeJS.ProcessEnv): string {
...
function resolveHookFailure(here: string): RuntimeError {
  return new RuntimeError(
    ...
    `Could not infer plugin root from setup module path ${here}. Set KIMI_PLUGIN_CC_HOOK_SCRIPT to the absolute path of dist/hooks/approval-hook.js.`,
    "setup.resolve-hook",
    { details: { here } },
  );
}
